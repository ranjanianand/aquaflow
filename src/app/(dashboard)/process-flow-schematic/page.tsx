...
import { SchematicCanvas } from '@/components/process-flow/schematic-canvas';
import { SchematicNodeData, EquipmentType } from '@/components/process-flow/schematic-node';
import {
  Download,
  Droplets,
  Gauge,
...
export default function ProcessFlowSchematicPage() {
  ...
  return (
    <div className="min-h-screen">
      <Header
        title="P&ID Schematic View"
        subtitle="Industrial-style process diagram with ISA symbols"
      />
        ...
        <Card className="overflow-hidden">
          ...
          <div className="flex items-center justify-between px-4 py-2 border-b bg-muted/30">
            <div className="flex items-center gap-2 text-[12px]">
              ...
              <span className="text-muted-foreground">Schematic P&ID View</span>
          ...
          <div style={{ height: 'calc(100vh - 160px)', minHeight: '600px' }}>
            <SchematicCanvas onNodeSelect={handleNodeSelect} />
          </div>
        </Card>
      </div>
